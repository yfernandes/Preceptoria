...
export async function createPreceptor(data: {
	userId: string
	hospitalId: string
...
export async function findAllPreceptors(query?: {
	hospitalId?: string
	specialty?: string
	limit?: number
	offset?: number
...
export async function findPreceptorById(id: string) {
...
export async function deletePreceptor(id: string) {
