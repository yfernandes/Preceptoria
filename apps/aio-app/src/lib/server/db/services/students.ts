...
export async function createStudent(data: { userId: string; classId: string; registrationNumber?: string }) {
...
export async function updateStudent(id: string, data: Partial<{ classId: string; registrationNumber: string }>) {
