	...
	.delete("/:id", async ({ params: { id }, requester }) => {
		try {
			...
			if (school.courses.length > 0) {
				return error(400, { 
					success: false, 
					message: "Cannot delete school that has courses. Please remove or reassign courses first." 
				});
			}
			...
			if (school.supervisors.length > 0) {
				return error(400, { 
					success: false, 
					message: "Cannot delete school that has supervisors. Please remove or reassign supervisors first." 
				});
			}
			...
			if (school.orgAdmin.length > 0) {
				return error(400, { 
					success: false, 
					message: "Cannot delete school that has org admins. Please remove or reassign org admins first." 
				});
			}
