...
import type { UserRoles } from "@api/modules/common/role.abstract"
...
import { Entity, Enum, OneToOne, Property, type Rel } from "@mikro-orm/postgresql"
import { IsEmail, IsNotEmpty, IsPhoneNumber, validateOrReject } from "class-validator"
