...
export class GoogleSheetsService {
	...
	constructor() {
		this.credentialsFile = path.join(__dirname, "../../secrets/service_account.json")
	...
	async getSubmissions(
		...
		try {
			...
			console.log(`Fetched ${submissions.length.toString()} submissions from Google Sheets`)
	...
	consolidateSubmissionsByCrefito(submissions: GoogleSheetsSubmission[]): ConsolidatedSubmission[] {
		...
		console.log(`📊 Found ${crefitoGroups.size.toString()} unique Crefito numbers`)
		...
		console.log(`✅ Consolidated into ${consolidated.length.toString()} unique students`)
